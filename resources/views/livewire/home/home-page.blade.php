                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex bg-gray-100 p-2 py-3">
                        <div class="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-2">
                            <div class="w-full bg-[#285a49] rounded-lg shadow p-4">
                                <!-- Airline Info -->
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <!-- Airline Logo -->
                                        <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-900"
                                                viewBox="0 0 512 512">
                                                <path fill="currentColor"
                                                    d="M217.4 27.43c-27.9.47-53.1 17.11-64.5 42.84l136.5 41.23c6-35.79-15.5-70.49-50.1-81.02c-6.2-1.88-12.7-2.91-19.2-3.05zm-69.7 60.08c-6.1 35.89 15.4 70.69 50.1 81.19c34.8 10.5 71.9-6.7 86.5-40zm265.5 44.29c-25.3.1-52.2 12.3-72.5 41L215.9 349.7c-33.5 47.4-18.9 97 14.1 120.4c33.1 23.5 84.6 20.8 118.1-26.6l124.7-176.8c33.5-47.5 18.9-97-14.1-120.5c-12.4-8.8-27.3-13.9-43-14.4zm-1.8 17.3c1.3 0 2.6 0 3.8.1c12.1.5 23.5 4.8 33.1 11.7c25.7 18.2 38.6 54.5 9.7 95.4l-64.5 91.5c-35.8-9.6-81.8-42.3-102.7-73l64.7-91.6c16.9-23.9 37-33.7 55.9-34.1M91.25 225.3c-9.62.1-19.11 2.1-27.93 6c-33.11 14.5-50.34 51.5-40.24 86.3l130.72-57.1c-13.1-22.1-36.9-35.5-62.55-35.2m69.65 51.6L30.2 334.1c18.45 31.4 57.3 44 90.6 29.5c33.2-14.6 50.4-51.8 40.1-86.7" />
                                            </svg>
                                        ...
                                        <div class="ml-3">
                                            <p class="text-white font-semibold">Medicine</p>
                                            <p class="text-sm text-white">Session 1</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-white">1 hour</div>
                                </div>

                                <!-- Flight Info -->
                                <div class="my-4 border-t border-white/50 pt-4">
                                    <div class="flex justify-between items-center">
                                        <!-- Departure -->
                                        <div>
                                            <p class="text-sm font-bold text-white">11:00 am</p>
                                        </div>
                                        <!-- Flight Icon -->
                                        ...
                                        <!-- Arrival -->
                                        <div>
                                            <p class="text-sm font-bold text-white">12:00 PM</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Medicine</p>
                                            <p class="text-sm text-gray-500">Session 2</p>
                                        </div>
                                    </div>
                                ...
                                <div class="my-4 border-t border-gray-200 pt-4">
                                    <div class="flex justify-between items-center">
                                        <!-- Departure -->
                                        <div>
                                            <p class="text-sm font-bold text-[#285a49]">12:00 PM</p>
                                        </div>
                                        <!-- Flight Icon -->
                                        <div class="text-gray-500">
                                        ...
                                        <!-- Arrival -->
                                        <div>
                                            <p class="text-sm font-bold text-[#285a49]">01:00 PM</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Medicine</p>
                                            <p class="text-sm text-gray-500">Session 3</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">1 hour</div>
                                </div>
                                ...
                                <div class="my-4 border-t border-gray-200 pt-4">
                                    <div class="flex justify-between items-center">
                                        <!-- Departure -->
                                        <div>
                                            <p class="text-sm font-bold text-[#285a49]">04:00 PM</p>
                                        </div>
                                        <!-- Flight Icon -->
                                        <div class="text-gray-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <!-- Arrival -->
                                        <div>
                                            <p class="text-sm font-bold text-[#285a49]">05:00 PM</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Medicine</p>
                                            <p class="text-sm text-gray-500">Session 4</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">1 hour</div>
                                </div>
                                ...
                                <div class="my-4 border-t border-gray-200 pt-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <!-- Arrival -->
                                        <div>
                                            <p class="text-sm font-bold text-[#285a49]">06:00 PM</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="flex gap-2 bg-gray-100 w-fit px-3 py-2 rounded-t-lg mt-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 512 512">
                            <path fill="currentColor"
                                d="M217.4 27.43c-27.9.47-53.1 17.11-64.5 42.84l136.5 41.23c6-35.79-15.5-70.49-50.1-81.02c-6.2-1.88-12.7-2.91-19.2-3.05zm-69.7 60.08c-6.1 35.89 15.4 70.69 50.1 81.19c34.8 10.5 71.9-6.7 86.5-40zm265.5 44.29c-25.3.1-52.2 12.3-72.5 41L215.9 349.7c-33.5 47.4-18.9 97 14.1 120.4c33.1 23.5 84.6 20.8 118.1-26.6l124.7-176.8c33.5-47.5 18.9-97-14.1-120.5c-12.4-8.8-27.3-13.9-43-14.4zm-1.8 17.3c1.3 0 2.6 0 3.8.1c12.1.5 23.5 4.8 33.1 11.7c25.7 18.2 38.6 54.5 9.7 95.4l-64.5 91.5c-35.8-9.6-81.8-42.3-102.7-73l64.7-91.6c16.9-23.9 37-33.7 55.9-34.1M91.25 225.3c-9.62.1-19.11 2.1-27.93 6c-33.11 14.5-50.34 51.5-40.24 86.3l130.72-57.1c-13.1-22.1-36.9-35.5-62.55-35.2m69.65 51.6L30.2 334.1c18.45 31.4 57.3 44 90.6 29.5c33.2-14.6 50.4-51.8 40.1-86.7" />
                        </svg>
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Pharmacy</p>
                                            <p class="text-sm text-gray-500">Session 1</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">1 hour</div>
                                </div>
                                ...
                                <div class="my-4 border-t border-gray-200 pt-4">
                                    <div class="flex justify-between items-center">
                                        <!-- Departure -->
                                        <div>
                                            <p class="text-sm font-bold text-[#285a49]">11:00 am</p>
                                        </div>
                                        <!-- Flight Icon -->
                                        <div class="text-gray-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Dentistry</p>
                                            <p class="text-sm text-gray-500">Session 1</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">1 hour</div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Allied Health</p>
                                            <p class="text-sm text-gray-500">Session 1</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">1 hour</div>
                            ...
                            <div class="w-full bg-white rounded-lg shadow p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-gray-900 font-semibold">Veterinary sciences</p>
                                            <p class="text-sm text-gray-500">Session 1</p>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">1 hour</div>
