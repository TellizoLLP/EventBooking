<div class="h-screen w-screen flex flex-col overflow-clip" x-data="alpineSystem">
    <div class="h-[calc(100vh-2rem)] overflow-y-auto w-full">
        ...
        {{ !$session['clickable'] || in_array($session['id'], $disabledTimeSlots) || ($session['slots'] != 0 && $slotsinline['filled'] >= 40) ? 'opacity-50 cursor-not-allowed bg-gray-300' : '' }}
                        ...
                        @endforeach
                        <div class="flex w-full justify-end mt-8 items-center">
                            <div class="flex gap-2">
                                <button @click="$wire.pageTwoSave()" wire:loading.attr="disabled"
                                    class="text-sm font-semibold text-neutral-500 bg-neutral-100 px-3 py-2 rounded-lg antialiased">Skip</button>
                                <div class="flex justify-end">
                ...
                <div class="">
                    <div class="flex w-full justify-between items-center">
                        <div class="flex flex-col">
                            ...
                            <div class="text-xs font-medium text-gray-600 mb-4 antialiased">You can select any sessions
                                below</div>
                        </div>
                        <div class="flex gap-2">
