    ...
    <div class="w-full h-full overflow-y-auto">
        ...
        <div class="p-6 bg-gray-100 space-y-6 relative">
            <div class="bg-white p-6 rounded-lg shadow" x-show="page == 1"
                ...
                <h2 class="text-lg font-semibold text-gray-800">Specialty</h2>
                <div class="text-xs font-medium text-gray-600 mb-4">You can choose only 3 of the 5 Medzone experiences
                    below</div>
